...
fn main() {
    ...
    println!("cargo:rerun-if-changed=src/concepts/attributes/inherits.rs");
    println!("cargo:rerun-if-changed=src/concepts/attributes/owner.rs");
    println!("cargo:rerun-if-changed=src/concepts/attributes/value.rs");
