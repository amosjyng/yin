...
impl From<HasProperty> for Attribute {
    fn from(this: HasProperty) -> Attribute {
...
mod tests {
    ...
    fn check_type_attributes() {
        initialize_kb();
        assert_eq!(HasProperty::archetype().added_attributes(), vec![]);
        #[rustfmt::skip]
        assert_eq!(HasProperty::archetype().attributes(), vec![Owner::archetype(), Value::archetype()]);
    }
    ...
    fn check_attribute_constraints() {
        initialize_kb();
        assert_eq!(HasProperty::archetype().owner_archetype(), Tao::archetype());
        assert_eq!(
