...
/// Describes instances of an archetype as having certain other
/// properties.\n\nFor example, a string may have a length of 5. But on a more
/// meta level, that means that the string has a length property or length
/// "attribute". That's where this attribute comes in.
